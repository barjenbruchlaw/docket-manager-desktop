  ...
  return (
    <Navbar bg="light">
      <Container className='fw-bold text-center'>
        ...
        <Nav.Link href="#search" disabled><Search className='fs-3 m-1' /><br />Search for a case</Nav.Link>
        ...
        <Nav.Link href="/system" disabled><Gear className='fs-3 m-1' disabled/><br />System Maintenance</Nav.Link>
